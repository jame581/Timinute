...
namespace Timinute.Server.Data.Migrations
{
    ...
    [Migration("20260719134402_AddMcpActivityLog")]
    partial class AddMcpActivityLog
    {
        /// <inheritdoc />
                    ...
                    b.OwnsOne("Timinute.Server.Models.UserPreferences", "Preferences", b1 =>
                        {
                            ...
                            b1.Property<decimal>("WorkdayHoursPerDay")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("decimal(4,1)")
                            ...
                            b1.HasData(
                                new
                                {
                                    ApplicationUserId = "a1b2c3d4-e5f6-4a5b-8c7d-9e0f1a2b3c4d",
                                    Theme = "System",
                                ...
                                new
                                {
                                    ApplicationUserId = "b2c3d4e5-f6a7-4b5c-8d7e-0f1a2b3c4d5e",
                                    Theme = "System",
                                    WeeklyGoalHours = 32.0m,
                                    WorkdayHoursPerDay = 8.0m
                                },
                                new
                                {
                                    ApplicationUserId = "c3d4e5f6-a7b8-4c5d-8e7f-1a2b3c4d5e6f",
                                    Theme = "System",
                                    WeeklyGoalHours = 32.0m,
                                    WorkdayHoursPerDay = 8.0m
                                });
